...
For part 2, install the program (you will get two programs installed, SimVC and SimCC, for voltage clamp and current clamp simulations, respectively).
...
You can download the .cc4 files you need for part 2, [here](../static_files/code/ps1_pt2.cc4)
